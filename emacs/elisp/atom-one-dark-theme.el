...
(atom-one-dark-with-color-variables
  (custom-theme-set-faces
   ...
   `(error ((t (:foreground ,atom-one-dark-red-1 :weight ExtraBold))))
   `(link ((t (:foreground ,atom-one-dark-blue :underline t :weight ExtraBold))))
   `(link-visited ((t (:foreground ,atom-one-dark-blue :underline t :weight SemiBold))))
   ...
   `(font-lock-comment-face ((t (:foreground ,atom-one-dark-fg :slant italic :weight ExtraBold))))
   `(font-lock-comment-delimiter-face ((default (:inherit (font-lock-comment-face)))))
   `(font-lock-doc-face ((t (:inherit (font-lock-string-face)))))
   `(font-lock-function-name-face ((t (:foreground ,atom-one-dark-blue))))
   `(font-lock-keyword-face ((t (:foreground ,atom-one-dark-purple :weight SemiBold))))
   ...
   `(font-lock-warning-face ((t (:foreground ,atom-one-dark-mono-3 :ExtraBold t))))
   `(font-lock-negation-char-face ((t (:foreground ,atom-one-dark-cyan :ExtraBold t))))

   ;; mode-line
   `(mode-line ((t (:background ,atom-one-dark-black :foreground ,atom-one-dark-silver :box (:color ,atom-one-dark-border :line-width 1)))))
   `(mode-line-buffer-id ((t (:weight ExtraBold))))
   `(mode-line-emphasis ((t (:weight ExtraBold))))
   ...
   ;; ido
   `(ido-first-match ((t (:foreground ,atom-one-dark-purple :weight ExtraBold))))
   `(ido-only-match ((t (:foreground ,atom-one-dark-red-1 :weight ExtraBold))))
   ...
   `(aw-leading-char-face ((t (:foreground ,atom-one-dark-red-1 :weight ExtraBold))))

   ;; centaur-tabs
   `(centaur-tabs-default ((t (:background ,atom-one-dark-black :foreground ,atom-one-dark-black))))
   `(centaur-tabs-selected ((t (:background ,atom-one-dark-bg :foreground ,atom-one-dark-fg :weight ExtraBold))))
   ...
   `(centaur-tabs-selected-modified ((t (:background ,atom-one-dark-bg
                                                     :foreground ,atom-one-dark-blue :weight ExtraBold))))
   ...
   `(compilation-mode-line-exit ((t (:inherit compilation-info :weight ExtraBold))))
   `(compilation-mode-line-fail ((t (:inherit compilation-error :weight ExtraBold))))
   ...
   `(helm-ff-directory ((t (:foreground ,atom-one-dark-cyan :background ,atom-one-dark-bg :weight ExtraBold))))
   `(helm-ff-file ((t (:foreground ,atom-one-dark-fg :background ,atom-one-dark-bg :weight SemiBold))))
   `(helm-ff-executable ((t (:foreground ,atom-one-dark-green :background ,atom-one-dark-bg :weight SemiBold))))
   `(helm-ff-invalid-symlink ((t (:foreground ,atom-one-dark-red-1 :background ,atom-one-dark-bg :weight ExtraBold))))
   `(helm-ff-symlink ((t (:foreground ,atom-one-dark-orange-2 :background ,atom-one-dark-bg :weight ExtraBold))))
   `(helm-ff-prefix ((t (:foreground ,atom-one-dark-bg :background ,atom-one-dark-orange-2 :weight SemiBold))))
   ...
   `(ivy-current-match ((t (:background ,atom-one-dark-gray :weight SemiBold))))
   ...
   ;; counsel
   `(counsel-key-binding ((t (:foreground ,atom-one-dark-orange-2 :weight ExtraBold))))
   ...
   ;; git-commit
   `(git-commit-comment-action  ((t (:foreground ,atom-one-dark-green :weight ExtraBold))))
   `(git-commit-comment-branch  ((t (:foreground ,atom-one-dark-blue :weight ExtraBold))))
   `(git-commit-comment-heading ((t (:foreground ,atom-one-dark-orange-2 :weight ExtraBold))))

   ;; git-gutter
   `(git-gutter:added ((t (:foreground ,atom-one-dark-green :weight ExtraBold))))
   `(git-gutter:deleted ((t (:foreground ,atom-one-dark-red-1 :weight ExtraBold))))
   `(git-gutter:modified ((t (:foreground ,atom-one-dark-orange-1 :weight ExtraBold))))

   ;; eshell
   `(eshell-ls-archive ((t (:foreground ,atom-one-dark-purple :weight ExtraBold))))
   `(eshell-ls-backup ((t (:foreground ,atom-one-dark-orange-2))))
   `(eshell-ls-clutter ((t (:foreground ,atom-one-dark-red-2 :weight ExtraBold))))
   `(eshell-ls-directory ((t (:foreground ,atom-one-dark-blue :weight ExtraBold))))
   `(eshell-ls-executable ((t (:foreground ,atom-one-dark-green :weight ExtraBold))))
   `(eshell-ls-missing ((t (:foreground ,atom-one-dark-red-1 :weight ExtraBold))))
   `(eshell-ls-product ((t (:foreground ,atom-one-dark-orange-2))))
   `(eshell-ls-special ((t (:foreground "#FD5FF1" :weight ExtraBold))))
   `(eshell-ls-symlink ((t (:foreground ,atom-one-dark-cyan :weight ExtraBold))))
   `(eshell-ls-unreadable ((t (:foreground ,atom-one-dark-mono-1))))
   `(eshell-prompt ((t (:inherit minibuffer-prompt))))

   ;; man
   `(Man-overstrike ((t (:inherit font-lock-type-face :weight ExtraBold))))
   `(Man-underline ((t (:inherit font-lock-keyword-face :slant italic :weight ExtraBold))))

   ;; woman
   `(woman-ExtraBold ((t (:inherit font-lock-type-face :weight bold))))
   `(woman-italic ((t (:inherit font-lock-keyword-face :slant italic :weight ExtraBold))))

   ;; dictionary
   `(dictionary-button-face ((t (:inherit widget-button))))
   `(dictionary-reference-face ((t (:inherit font-lock-type-face :weight ExtraBold))))
   `(dictionary-word-entry-face ((t (:inherit font-lock-keyword-face :slant italic :weight ExtraBold))))
   ...
   `(erc-timestamp-face ((t (:foreground ,atom-one-dark-green :weight ExtraBold))))
   ...
   `(jabber-roster-user-error ((t (:foreground ,atom-one-dark-red-1 :ExtraBold t))))
   ...
   `(magit-section-heading ((t (:foreground ,atom-one-dark-orange-2 :weight ExtraBold))))
   `(magit-section-heading-selection ((t (:foreground ,atom-one-dark-fg :weight ExtraBold))))
   `(magit-diff-file-heading ((t (:weight ExtraBold))))
   `(magit-diff-file-heading-highlight ((t (:background ,atom-one-dark-gray :weight ExtraBold))))
   `(magit-diff-file-heading-selection ((t (:foreground ,atom-one-dark-orange-2 :background ,atom-one-dark-bg-hl :weight ExtraBold))))
   ...
   `(magit-tag  ((t (:foreground ,atom-one-dark-orange-1 :weight ExtraBold))))
   `(magit-branch-remote  ((t (:foreground ,atom-one-dark-green :weight ExtraBold))))
   `(magit-branch-local   ((t (:foreground ,atom-one-dark-blue :weight ExtraBold))))
   `(magit-branch-current ((t (:foreground ,atom-one-dark-blue :weight ExtraBold :box t))))
   `(magit-head           ((t (:foreground ,atom-one-dark-blue :weight ExtraBold))))
   `(magit-refname        ((t (:background ,atom-one-dark-bg :foreground ,atom-one-dark-fg :weight ExtraBold))))
   `(magit-refname-stash  ((t (:background ,atom-one-dark-bg :foreground ,atom-one-dark-fg :weight ExtraBold))))
   `(magit-refname-wip    ((t (:background ,atom-one-dark-bg :foreground ,atom-one-dark-fg :weight ExtraBold))))
   ...
   `(message-header-cc ((t (:foreground ,atom-one-dark-orange-1 :weight ExtraBold))))
   `(message-header-name ((t (:foreground ,atom-one-dark-purple))))
   `(message-header-newsgroups ((t (:foreground ,atom-one-dark-orange-2 :weight ExtraBold :slant italic))))
   `(message-header-other ((t (:foreground ,atom-one-dark-red-1))))
   `(message-header-subject ((t (:foreground ,atom-one-dark-blue))))
   `(message-header-to ((t (:foreground ,atom-one-dark-orange-2 :weight ExtraBold))))
   ...
   `(epa-field-name ((t (:foreground ,atom-one-dark-cyan :weight ExtraBold))))
   ...
   `(rainbow-delimiters-unmatched-face ((t (:foreground ,atom-one-dark-red-1 :weight ExtraBold))))
   ...
   ;; show-paren
   `(show-paren-match ((,class (:foreground ,atom-one-dark-purple :inherit ExtraBold :underline t))))
   `(show-paren-mismatch ((,class (:foreground ,atom-one-dark-red-1 :inherit ExtraBold :underline t))))
   ...
   ;; smartparens
   `(sp-show-pair-mismatch-face ((t (:foreground ,atom-one-dark-red-1 :background ,atom-one-dark-gray :weight ExtraBold))))
   `(sp-show-pair-match-face ((t (:background ,atom-one-dark-gray :weight ExtraBold))))
   ...
   ;; flx-ido
   `(flx-highlight-face ((t (:inherit (link) :weight ExtraBold))))
   ...
   ;; guix
   `(guix-true ((t (:foreground ,atom-one-dark-green :weight ExtraBold))))
   `(guix-build-log-phase-end ((t (:inherit success))))
   `(guix-build-log-phase-start ((t (:inherit success :weight ExtraBold))))

   ;; gomoku
   `(gomoku-O ((t (:foreground ,atom-one-dark-red-1 :weight ExtraBold))))
   `(gomoku-X ((t (:foreground ,atom-one-dark-green :weight ExtraBold))))
   ...
   `(tabbar-selected ((,class (:inherit tabbar-default :foreground ,atom-one-dark-fg :background ,atom-one-dark-bg :weight ExtraBold :underline nil :box (:line-width 1 :color ,atom-one-dark-bg)))))
   ...
   `(font-latex-ExtraBold-face ((t (:foreground ,atom-one-dark-green :weight bold))))
   ...
   `(org-document-title ((t (:weight ExtraBold))))
   ...
   `(breakpoint-enabled ((t (:foreground ,atom-one-dark-red-1 :weight ExtraBold))))
   ...
   ;; rmsbolt
   `(rmsbolt-current-line-face ((t (:inherit hl-line :weight ExtraBold))))
